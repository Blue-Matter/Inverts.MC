...
#' @seealso \link{RCM}
#' @export
cond.MC = function(RCMinput, sims = 12, max_F = 2.3, comp_like = "multinomial", resample = F, silent=T){
  setup()
  ...
  RCMfit = RCM(OM, RCMinput[[3]], selectivity = "logistic_length", s_selectivity=c("logistic_age","B","B"),
             max_F = max_F, mean_fit = T, comp_like = comp_like, condition = "catch", cores = 8,
